...
bc.   source /cvmfs/fermilab.opensciencegrid.org/products/genie/externals/setup
...
bc.   setup root v5_34_25a -q debug:e7:nu
...
bc.   setup genie v2_8_6a -q debug:e7
...
bc. genie v2_8_6a -f Linux64bit+2.6-2.12 -z /grid/fermiapp/products/genie/externals -q debug:e7
...
bc. $ source /grid/fermiapp/products/genie/externals/setup
...
bc.    --with-pythia6-lib=${PYTHIA_FQ_DIR}/lib
...
bc.   curl -O http://scisoft.fnal.gov/scisoft/bundles/tools/getManifestList
...
bc. ssh geniepro@geniegpvm01.fnal.gov
...
bc.    find . -type d ! -perm -5   | xargs chmod a+rx
   find . -type f ! -perm -a+r | xargs chmod a+r

h2. Ensuring that CVMFS is up-to-date on a node

bc.    /cvmfs/grid.cern.ch/util/cvmfs-uptodate  /cvmfs/fermilab.opensciencegrid.org/products/genie
