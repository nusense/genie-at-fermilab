...
bc. pip install matplotlib -t /path/to/your/local/matplotlib
...
bc. pip install iMinuit -t /path/to/you/local/iMinuit
...
bc. wget http://www.hepforge.org/archive/professor/Professor-2.2.2.tar.gz
...
bc. wget http://www.hepforge.org/archive/yoda/YODA-1.6.7.tar.gz
...
bc. wget http://bitbucket.org/eigen/eigen/get/3.3.4.tar.gz
...
bc.. tar -xzf Professor-2.2.2.tar.gz
cd Professor-2.2.2
...
bc. Polynomial order     Minimum samples
         0                   1
         1                   4
         2                  10
         3                  20
...
bc. export LD_LIBRARY_PATH=/path-to/YODA-1.6.7-install/lib:$LD_LIBRARY_PATH
...
bc. export PYTHONPATH=$PWD/lib/python2.7/site-packages:$PYTHONPATH
...
bc. pip install pyDOE -t /path/to/you/local/pyDOE
...
bc. pip  install   simpy -t /path/to/your/local/sympy
...
bc. /genie/app/yarba_j/Professor-Install-Trial/Geant4-FTF-Professor
...
bc.. prof2-ipol  scan  - it'll create file ipol.dat (Eigen interpolation of the data)
...
p. The output is written to the "tunes" directory.
