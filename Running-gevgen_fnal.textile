...
bc.. export GEOMETRY="mylardetector.gdml"       # or whatever (.root is okay too)
...
bc. export FLUXFILE="myfakeflux.gsimple.root"  #
...
bc. export FLUXFILE="myfakeflux.dk2nu.root"  #   or "myflugg.root" or "myg4numi.root"
export DETLOC="MyParamSetName"           # <param_set> name in first GNuMINtuple.xml file found

h2. Run Specific Parameters

bc.. export run=12345   # arbitrary run number
...
p. General, little known but important, note:
